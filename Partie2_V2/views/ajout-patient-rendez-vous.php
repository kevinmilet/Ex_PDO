                ...
                <div class="row view-div">
                    <div class="col-md-4 mb-3">
                        ...
                        <select class="form-control" name="patient" id="patient" required>
                            ...
                            <option value="<?=htmlentities($patient->id)?>"
                                <?=isset($_POST['patient']) && ($_POST['patient'] == $patient->id) ? 'selected' : ''?>>
                                <?=htmlentities($patient->firstname)?> <?=htmlentities($patient->lastname)?></option>
                            <?php endforeach ?>
                        </select>
